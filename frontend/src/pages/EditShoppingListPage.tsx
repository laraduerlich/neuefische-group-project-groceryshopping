...
import {getShoppingListById, createShoppingList} from "../utils/dataService.ts";
        ...
        if (id) {
            ...
            getShoppingListById(id)
                .then((data: ShoppingList) => {
                    setShoppingListName(data.name); // Set the shopping list name
                    setItems(data.list); // Set the items in the shopping list
                })
                .catch((error) => {
